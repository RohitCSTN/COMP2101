...
function displayhelp {
      echo "Usage: Usage [-dms] [pattern...] display system information about builtin commands with selected options.

        where options:
        --help|h: display help information of the system
        --host: display information about the host
        --domain: shows report about the domain
        --ipconfig: display ip addresses on the system
        --os: shows the details about operating system
        --cpu: display report about the cpu/host
        --memory: shows information about system memory
        --disk: display report on system disk space utilization
        --printer: shows details about printers attached to the system"
}
